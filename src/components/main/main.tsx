      ...
      <div className="content">
        ...
        <div className="art">
          <div className="background">
            ...
            <img className="image" src="./images/asara.jpg" />
          </div>
          <div className="description">
            <p>
              ...
              editorial design, advertising design and many more. On recent
              years I’ve been shifting my focus on web and digital product
              design. I very much value both creative madness and elegant
              funcionality. For me all is one and one is all. Design Is a never
              ending journey so I’m always up for adventure so if you’re
              interested in partnership - let’s chat!
            </p>
          </div>
        </div>
      </div>
      <img className="background-element" src="./images/kreive1.svg" alt="" />
    </section>
    ...
    <section className="work" id="work">
      ...
      <div className="work-item work-item--bigger-image work-item--reverse work-item--animated js-work-item">
        ...
        <div className="work-about">
          ...
          <p className="work-about__caption">PERSONAL PROJECT | ILLUSTRATION</p>
          <p className="work-about__description">
            Just a silly weekend evening illustration during the first
            quarantine lockdown in Lithuania. Everybody felt a bit
            claustrophobic, bored and sometimes a bit mad. For me it meant more
            time at my quality spots.
          </p>
        </div>
      </div>
      ...
      <div className="work-item work-item--bigger-image work-item--more-space work-item--animated js-work-item">
        ...
        <div className="work-about">
          ...
          <p className="work-about__description">
            ...
            fasting. This campaign is focused to promote DoFasting app and
            educate people about intermittent fasting.
          </p>
        </div>
      </div>
      ...
      <div className="work-item work-item--animated js-work-item">
        ...
        <div className="work-about">
          ...
          <p className="work-about__description">
            “You’re either a superstar or an alley bum, a hero or a villain”
            that was the slogan of a company Christmas party hosted by Kilo
            Health. Any kind of social or cultural contrast was the very essence
            of this event.
          </p>
        </div>
      </div>
